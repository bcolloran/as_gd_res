...
"$GODOT_BIN" --headless --editor --path "$REPO_ROOT/resource_test_godot_project" --quit

"$GODOT_BIN" --headless --path "$REPO_ROOT/resource_test_godot_project" test_scene.tscn > "$OUTPUT"
